...
def test_bucket_scanner_early_exit_on_interrupt():
...
def test_glacier_restorer_early_exit_on_interrupt():
...
def test_glacier_waiter_early_exit_on_interrupt_during_loop():
...
def test_bucket_scanner_handles_pagination_error():
...
def test_glacier_restorer_handles_non_restore_error():
