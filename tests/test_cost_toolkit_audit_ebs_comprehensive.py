...
class TestGetAllRegions:
    ...
    def test_get_regions_error(self, capsys):
...
class TestCalculateVolumeCost:
    """Tests for _calculate_volume_cost function."""

    def test_calculate_volume_costs(self):
...
class TestGetAttachmentInfo:
    """Tests for _get_attachment_info function."""

    def test_get_attachment_info(self):
        """Test getting attachment info for various scenarios."""
        assert (
            _get_attachment_info({"Attachments": [{"InstanceId": "i-123456"}]})
            == "Instance: i-123456"
        )
...
class TestProcessSnapshot:
    """Tests for _process_snapshot function."""

    def test_process_snapshot(self, capsys):
...
class TestAuditRegion:
    """Tests for _audit_region function."""

    def test_audit_region(self, capsys):
...
class TestPrintVolumeBreakdown:
    """Tests for _print_volume_breakdown function."""
...
class TestPrintUnattachedVolumes:
    """Tests for _print_unattached_volumes function."""

    def test_print_unattached_volumes(self, capsys):
...
class TestPrintOldSnapshots:
    """Tests for _print_old_snapshots function."""

    def test_print_old_snapshots(self, capsys):
...
class TestAuditEbsVolumes:
    """Tests for audit_ebs_volumes function."""

    def test_audit_volumes(self, capsys):
