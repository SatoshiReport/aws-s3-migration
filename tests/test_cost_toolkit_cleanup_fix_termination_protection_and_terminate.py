...
class TestDisableTerminationProtection:
    ...
    def test_disable_protection_client_error(self, capsys):
        ...
        with patch("cost_toolkit.scripts.aws_ec2_operations.create_ec2_client") as mock_create:
            mock_ec2 = MagicMock()
            error = ClientError({"Error": {"Code": "InvalidInstanceID"}}, "modify_instance_attribute")  # noqa: E501
    ...
    def test_disable_protection_uses_credentials(self):
        ...
        with patch("cost_toolkit.scripts.aws_ec2_operations.create_ec2_client") as mock_create:
            ...
            mock_create.assert_called_once_with(region="eu-west-2", aws_access_key_id="my_key", aws_secret_access_key="my_secret")
...
class TestTerminateInstance:
    ...
    def test_terminate_instance_uses_credentials(self):
        ...
        with patch("cost_toolkit.scripts.aws_ec2_operations.create_ec2_client") as mock_create:
            ...
            mock_create.assert_called_once_with(region="ap-south-1", aws_access_key_id="my_key", aws_secret_access_key="my_secret")
    ...
    def test_main_protection_disable_fails(self, capsys):
        ...
        with patch("builtins.input", return_value="DISABLE PROTECTION AND TERMINATE"):
            with patch("cost_toolkit.scripts.cleanup.aws_fix_termination_protection_and_terminate." "setup_aws_credentials") as mock_load:
                ...
                with patch("cost_toolkit.scripts.aws_ec2_operations.create_ec2_client") as mock_create:
                    mock_ec2 = MagicMock()
                    error = ClientError({"Error": {"Code": "InvalidInstanceID"}}, "modify_instance_attribute")
                    mock_ec2.modify_instance_attribute.side_effect = error
                    mock_create.return_value = mock_ec2
                    main()
                    captured = capsys.readouterr()
